 ...
 */
public class LanceTrappeur {
	
	private static String usage = "USAGE : java " + LanceTrappeur.class.getName() + " [ port [ ipArene ] ]";
	...
	public static void main(String[] args) {
		...
		try {
			...
			new StrategieTrappeur(ipArene, port, ipConsole, nom, groupe, caracts, nbTours, position, logger);
